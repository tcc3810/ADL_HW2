...
def main():
    ...
    def prepare_validation_features(examples):
        ...
        tokenized_examples = tokenizer(
            examples[question_column_name] if pad_on_right else [context for context in example[context_column_name]],
    ...
    #metric = load_metric("./question_answering/metric_qa.py")
    ...
    if args.do_predict:
        ...
        epoch_pbar = tqdm(enumerate(predict_dataloader), total=len(predict_dataloader), ncols=100)
        ...
        with open(args.output_file , "w") as file:
            ...
            for data in prediction.predictions:
                writer.writerow([data["id"],data["prediction_text"]])
